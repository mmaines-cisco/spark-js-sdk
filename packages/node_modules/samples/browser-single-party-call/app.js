...
function bindCallEvents(call) {
  ...
  call.once(`remoteMediaStream:change`, () => {
    ...
    // track.
    document.getElementById(`remote-view-video`).srcObject = new MediaStream([call.remoteMediaStream.getVideoTracks()[0]]);
    document.getElementById(`remote-view-audio`).srcObject = new MediaStream([call.remoteMediaStream.getAudioTracks()[0]]);
  });
