...
describe(`plugin-avatar`, () => {
  ...
  beforeEach(() => {
    ...
    spark.config.avatar.batcherWait = 1500;
    spark.config.avatar.batcherMaxCalls = 100;
    spark.config.avatar.batcherMaxWait = 100;
    spark.config.avatar.defaultMaxAge = 60 * 60;
    spark.config.avatar.defaultAvatarSize = 80;
    spark.config.avatar.cacheControl = 3600;
  });
