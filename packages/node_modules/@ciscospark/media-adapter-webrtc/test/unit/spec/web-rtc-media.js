...
//             assert.equal(m.pc.signalingState, `stable`);
//             return p;
//           })
//           .then(() => {
...
//                     .then((answer) => m.acceptAnswer(answer))
//                     .then(() => {
//                       assert.lengthOf(m.pc.getLocalStreams(), 1);
...
//                       m.pc.getLocalStreams().forEach((stream) => {
...
//                     .then(() => assert.isBelow(m.pc.getLocalStreams().length, 2)));
//                 });
//               });
//             });
...
//                           assert.lengthOf(m.pc.getLocalStreams(), 1);
//                           assert.equal(m.pc.getLocalStreams()[0], stream);
...
//                     .then(() => {
//                       assert.lengthOf(m.pc.getRemoteStreams(), 1);
...
//                       m.pc.getRemoteStreams().forEach((stream) => {
