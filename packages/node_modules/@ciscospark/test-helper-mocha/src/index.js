 ...
 */
exports.flaky = function flaky(mochaMethod) {
 ...
 * @returns {Function} mochaMethod or mochaMethod.skip
 */
exports.skipInBrowser= function skipInBrowser(mochaMethod) {
  // If mochaMethod doesn't have a skip method, assume that mochaMethod is
  // already either a .skip or a .only
  if (!mochaMethod.skip) {
    return mochaMethod;
 ...
 * @returns {Function} mochaMethod or mochaMethod.skip
 */
exports.skipInNode= function skipInNode(mochaMethod) {
  // If mochaMethod doesn't have a skip method, assume that mochaMethod is
  // already either a .skip or a .only
  if (!mochaMethod.skip) {
    return mochaMethod;
...
exports.skipInFirefox= function skipInFirefox(mochaMethod) {
  // If mochaMethod doesn't have a skip method, assume that mochaMethod is
  // already either a .skip or a .only
  if (!mochaMethod.skip) {
    return mochaMethod;
 ...
 * @returns {Function}
 */
exports.browserOnly= function browserOnly(mochaMethod) {
 ...
 * @returns {Function}
 */
exports.nodeOnly= function nodeOnly(mochaMethod) {
  return inNode() ? mochaMethod : noop;
};

exports.maxWaitForEvent= function maxWaitForEvent(max, event, emitter) {
  return Promise.race([
...
exports.maxWaitForPromise = function maxWaitForPromise(timeout, promise) {
  return Promise.race([
    promise,
